        ...
        <Card className="flex flex-col gap-y-4">
          <div className="flex gap-x-4 items-center">
            ...
            <p className="dark:text-white text-gray-900 text-justify">
              ...
              reporting! A big thank you to Erisa (Community Champion), Rian
              (Data Team, Cloudflare), and the entire Cloudflare team for such a
              quick response!
            </p>
          </div>
          <div className="flex gap-x-4 items-center">
            <RiShieldStarLine className="dark:text-white text-gray-900 size-8" />
            <p className="dark:text-white text-gray-900 text-justify">
              A big thank you to Erisa (Community Champion), Peps (Community
              Champion) and Sloth (Community MVP) for helping me mitigate DDoS
              attacks on my site!
            </p>
          </div>
        </Card>
